...
export default function About() {
  ...
  return (
    <>
      {/* Header */}
      <header className="flex items-center bg-white p-6 pb-2 shrink-0 sticky top-0 z-10 justify-between">
      ...
      <main className="flex-1 overflow-y-auto pb-4">
        ...
        <div className="px-4 py-2">
          <div className="relative w-full rounded-2xl overflow-hidden bg-gradient-to-br from-primary/15 via-emerald-50 to-teal-50 p-8 py-12">
            ...
            <p className="text-slate-800 text-2xl font-bold leading-snug">
              {a.heroText}
            </p>
          </div>
        </div>
        ...
        <section className="px-6 py-10 text-center">
          ...
          <p className="text-[#658671] text-base font-medium leading-relaxed max-w-md mx-auto">
            {a.whyDesc}
          </p>
        </section>
        ...
        <section className="px-6 py-8 bg-white border-t border-slate-100">
